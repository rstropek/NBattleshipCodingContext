namespace NBattleshipCodingContest.Logic.Tests
{
    ...
    public class RandomBoardFillterTests
    {
        ...
        public void Fill()
        {
            ...
            boardMock.Setup(b => b.TryPlaceShip(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<Direction>()))
                .Returns(true);
            ...
            boardMock.Verify(b => b.TryPlaceShip(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<Direction>()),
                Times.Exactly(3));
        }
